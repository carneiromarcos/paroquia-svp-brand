...
export default function HorariosPage() {
  usePageMeta({ title: "Horarios", description: "Horarios de missas, confissoes e adoracao da Paroquia SVP." });

  return (
    <>
      <PageHero title="Horarios" subtitle="Programacao completa da paroquia" />
      ...
      <section className="bg-cream py-16 px-6">
        <div className="max-w-[1100px] mx-auto">
          ...
          <h2 className="font-[var(--font-heading)] text-2xl md:text-3xl font-bold mb-6">Horarios das celebracoes</h2>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} className="max-w-lg mx-auto bg-surface rounded-xl overflow-hidden shadow-lg border border-muted">
            <div className="bg-navy text-white py-5 px-6 text-center">
              ...
              <h3 className="font-[var(--font-heading)] text-lg mt-1">Horarios das Missas</h3>
            </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid md:grid-cols-2 gap-6">
            <motion.div variants={fadeInUp} className="bg-surface border border-muted rounded-xl p-6 shadow-sm border-l-3 border-l-gold">
              <h3 className="font-[var(--font-heading)] text-lg mb-3">Confissoes</h3>
              <p className="text-sm text-dark/60 mb-2">{schedule.confessions}</p>
              <p className="text-xs text-dark/40">Nao e necessario agendamento.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="bg-surface border border-muted rounded-xl p-6 shadow-sm border-l-3 border-l-gold">
              <h3 className="font-[var(--font-heading)] text-lg mb-3">Adoracao ao Santissimo</h3>
      ...
      <section className="bg-cream py-16 px-6">
        <div className="max-w-[1100px] mx-auto">
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-gold mb-2">03 / Secretaria Paroquial</p>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="max-w-lg mx-auto bg-surface border border-muted rounded-xl p-6 shadow-sm">
            ...
            <p className="text-xs text-dark/50">Servicos: Batizado, Matrimonio, Certidoes, Intencoes de Missa, Dizimo.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-navy text-white py-14 px-6 text-center">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
          <h3 className="font-[var(--font-heading)] text-xl mb-2">Duvidas sobre horarios?</h3>
